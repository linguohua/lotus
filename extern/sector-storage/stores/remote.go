...
func NewRemote(local *Local, index SectorIndex, auth http.Header, fetchLimit int, groupID string) *Remote {
	return &Remote{
		local:   local,
		index:   index,
		groupID: groupID,
...
// lingh: miner call this method to Acquire Sector space

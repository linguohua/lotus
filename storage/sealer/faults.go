...
func (m *Manager) CheckProvableOffice(ctx context.Context, pp abi.RegisteredPoStProof, sectors []storage.SectorRef, rg storiface.RGetter) (map[abi.SectorID]string, error) {
...
// CheckProvable returns unprovable sectors
func (m *Manager) CheckProvable2(ctx context.Context, pp abi.RegisteredPoStProof, sectors []storage.SectorRef, update []bool, rg storiface.RGetter) (map[abi.SectorID]string, error) {
	var bad = make(map[abi.SectorID]string)
...
// CheckProvable returns unprovable sectors
func (m *Manager) CheckProvableExt(ctx context.Context, pp abi.RegisteredPoStProof, sectors []storage.SectorRef) (map[abi.SectorID]string, error) {
	var bad = make(map[abi.SectorID]string)

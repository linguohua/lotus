...
func newExistingSelector(queryWorker bool, index paths.SectorIndex, sector abi.SectorID, alloc storiface.SectorFileType, allowFetch bool, groupID string) *existingSelector {
	if groupID == "" {

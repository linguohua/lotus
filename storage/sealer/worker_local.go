...
func newLocalWorker(executor ExecutorFunc, wcfg WorkerConfig,
	store paths.Store, local *paths.Local, sindex paths.SectorIndex,
...
func NewLocalWorker(wcfg WorkerConfig, store paths.Store, local *paths.Local, sindex paths.SectorIndex,
	ret storiface.WorkerReturn, cst *statestore.StateStore, ext *LocalWorkerExtParams) *LocalWorker {
